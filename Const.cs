...
//TODO: Merge this into Enums
namespace OTNet.Const
{
    public enum MagicEffectClasses : byte {
        CONST_ME_NONE,
    ...
    public enum PlayerFlags : UInt64 {
        ...
        PlayerFlag_NotGenerateLoot = ((UInt64)1) << 31,
        PlayerFlag_CanTalkRedChannelAnonymous = ((UInt64)1) << 32,
        PlayerFlag_IgnoreProtectionZone = ((UInt64)1) << 33,
        PlayerFlag_IgnoreSpellCheck = ((UInt64)1) << 34,
        PlayerFlag_IgnoreWeaponCheck = ((UInt64)1) << 35,
        PlayerFlag_CannotBeMuted = ((UInt64)1) << 36,
        PlayerFlag_IsAlwaysPremium = ((UInt64)1) << 37,
    };

    public enum ReloadTypes : byte  {
        RELOAD_TYPE_ALL,
        RELOAD_TYPE_ACTIONS,
        RELOAD_TYPE_CHAT,
    ...
    public static class Maps {
        public static readonly FluidTypes[] ReverseFluidMap = new FluidTypes[] {
            FluidTypes.FLUID_NONE,
            FluidTypes.FLUID_WATER,
            FluidTypes.FLUID_MANA,
            FluidTypes.FLUID_BEER,
            FluidTypes.FLUID_NONE,
            FluidTypes.FLUID_BLOOD,
            FluidTypes.FLUID_SLIME,
            FluidTypes.FLUID_NONE,
            FluidTypes.FLUID_LEMONADE,
            FluidTypes.FLUID_MILK,
        };

        public static readonly FluidTypes[] ClientToServerFluidMap = new FluidTypes[] {
            FluidTypes.FLUID_NONE,
            FluidTypes.FLUID_WATER,
            FluidTypes.FLUID_MANA,
            FluidTypes.FLUID_BEER,
            FluidTypes.FLUID_MUD,
            FluidTypes.FLUID_BLOOD,
            FluidTypes.FLUID_SLIME,
            FluidTypes.FLUID_RUM,
            FluidTypes.FLUID_LEMONADE,
            FluidTypes.FLUID_MILK,
            FluidTypes.FLUID_WINE,
            FluidTypes.FLUID_LIFE,
            FluidTypes.FLUID_URINE,
            FluidTypes.FLUID_OIL,
            FluidTypes.FLUID_FRUITJUICE,
            FluidTypes.FLUID_COCONUTMILK,
            FluidTypes.FLUID_TEA,
            FluidTypes.FLUID_MEAD,
        };

        public static readonly ClientFluidTypes[] FluidMap = new ClientFluidTypes[]{
    ...
    public static class Constants{
        ...
        public const Int32 CHANNEL_CAST = 40;
        public const string LIVE_CAST_CHAT_NAME = "Live Cast Chat";

        public const Int32 STORAGEVALUE_PROMOTION = 30018;
        //Reserved player storage key ranges;
        //[10000000 - 20000000];
        public const Int32 PSTRG_RESERVED_RANGE_START = 10000000;
        public const Int32 PSTRG_RESERVED_RANGE_SIZE = 10000000;
        //[1000 - 1500];
        public const Int32 PSTRG_OUTFITS_RANGE_START = (PSTRG_RESERVED_RANGE_START + 1000);
        public const Int32 PSTRG_OUTFITS_RANGE_SIZE = 500;
        //[2001 - 2011];
        public const Int32 PSTRG_MOUNTS_RANGE_START = (PSTRG_RESERVED_RANGE_START + 2001);
        public const Int32 PSTRG_MOUNTS_RANGE_SIZE = 10;
        public const Int32 PSTRG_MOUNTS_CURRENTMOUNT = (PSTRG_MOUNTS_RANGE_START + 10);
    }
}